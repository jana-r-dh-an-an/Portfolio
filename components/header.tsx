...
export default function Header(){
    ...
    return <header className='z-[999] relative'>
        ...
        <motion.div className='fixed top-0  -translate-x-1/2 left-1/2 h-[4.5rem] w-full
        ...
        animate={{y:0,x:"-50%", opacity:1}}>
            ...
            -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
                ...
                <ul className='flex
                w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial]
